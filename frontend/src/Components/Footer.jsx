...
import { CodeforcesIcon, LeetCodeIcon, AtCoderIcon, CodeChefIcon } from "./PlatformIcons";
...
const navigation = {
  ...
  social: [
    {
      name: 'GitHub',
      href: 'https://github.com/AshikAHegde',
      icon: (props) => (
    ...
    {
      name: 'LinkedIn',
      href: 'https://linkedin.com/in/ashik-hegde',
      icon: (props) => (
        <svg fill="currentColor" viewBox="0 0 24 24" {...props}>
          <path
            fillRule="evenodd"
  ...
  platforms: [
    { name: 'Codeforces', href: 'https://codeforces.com', icon: CodeforcesIcon },
    { name: 'LeetCode', href: 'https://leetcode.com', icon: LeetCodeIcon },
    { name: 'AtCoder', href: 'https://atcoder.jp', icon: AtCoderIcon },
    { name: 'CodeChef', href: 'https://codechef.com', icon: CodeChefIcon },
  ]
}
